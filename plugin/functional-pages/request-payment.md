...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/plugin/functional-pages/request-payment.html"
source_route: "/miniprogram/dev/framework/plugin/functional-pages/request-payment.html"
raw_html: "raw-html/plugin/functional-pages/request-payment.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/plugin/functional-pages/request-payment.html](https://developers.weixin.qq.com/miniprogram/dev/framework/plugin/functional-pages/request-payment.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/plugin/functional-pages/request-payment.html`

# 支付功能页

**自2025年6月26日起，不再支持新申请插件支付功能，如果要在小程序中实现向第三方支付，请使用[「打开半屏小程序」功能](../../open-ability/openEmbeddedMiniProgram)。**

支付功能页用于帮助插件完成支付，相当于 [wx.requestPayment](https://developers.weixin.qq.com/miniprogram/dev/api/payment/wx.requestOrderPayment.html) 的功能。

自基础库版本 [2.22.1](../../compatibility) 起，可以直接在插件中调用 [wx.requestPluginPayment](https://developers.weixin.qq.com/miniprogram/dev/api/payment/wx.requestPluginPayment.html) 实现跳转支付；通过 [functional-page-navigator](https://developers.weixin.qq.com/miniprogram/dev/component/functional-page-navigator.html) 跳转将会被废弃。
...
自基础库版本 [2.22.1](../../compatibility) 起，推荐使用该方式。
...
### functional-page-navigator 方式（将废弃）
...
![支付功能页](../../assets/405a3fa0be9c47ee.png)
...
| callback | Function | 回调函数，调用该函数后，小程序将发起支付（类似于 [wx.requestPayment](https://developers.weixin.qq.com/miniprogram/dev/api/payment/wx.requestOrderPayment.html)） |
...
| requestPaymentArgs | Object | 支付参数，用于调用 [wx.requestPayment](https://developers.weixin.qq.com/miniprogram/dev/api/payment/wx.requestOrderPayment.html)，参数如下 |

**requestPaymentArgs 的参数：**

用于发起支付，和 [wx.requestPayment](https://developers.weixin.qq.com/miniprogram/dev/api/payment/wx.requestOrderPayment.html) 的参数相同，但没有回调函数（`success`, `fail`, `complete`）：
...
| extraData | any | 否 | 由开发者决定的自定义数据段，该字段将被无修改地透传到支付成功的回调参数中，具体见代码示例中的使用方法。基础库 [2.9.1](../../compatibility) 开始支持 |
