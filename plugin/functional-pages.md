...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/plugin/functional-pages.html"
source_route: "/miniprogram/dev/framework/plugin/functional-pages.html"
raw_html: "raw-html/plugin/functional-pages.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/plugin/functional-pages.html](https://developers.weixin.qq.com/miniprogram/dev/framework/plugin/functional-pages.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/plugin/functional-pages.html`

# 插件功能页

插件功能页从小程序基础库版本 [2.1.0](../compatibility) 开始支持。
...
- 获取用户信息，包括 `openid` 和昵称等（相当于 [wx.login](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/login/wx.login.html) 和 [wx.getUserInfo](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/user-info/wx.getUserInfo.html) 的功能），详见 [用户信息功能页](functional-pages/user-info)；

从基础库版本 [2.22.1](../compatibility) 起，以下功能页已经废弃，可以直接调用对应接口实现功能：

- 支付（直接使用 [wx.requestPluginPayment](https://developers.weixin.qq.com/miniprogram/dev/api/payment/wx.requestPluginPayment.html)）

从基础库版本 [2.16.1](../compatibility) 起，以下三个功能页已经废弃，可以直接调用对应接口实现功能；原有和新使用的 `<functional-page-navigator>` 在点击后将不会跳到功能页，而是直接生效：
...
使用插件功能页前，需要确定插件已经 [开通](https://developers.weixin.qq.com/miniprogram/introduction/plugin#%E6%8F%92%E4%BB%B6%E5%BC%80%E5%8F%91%E6%8E%A5%E5%85%A5%E6%B5%81%E7%A8%8B)，否则可能出现 `functional-page-navigator` 点击后无响应等情况
...
从小程序基础库版本 [2.4.0](../compatibility) 开始，支持插件所有者小程序跳转到自己的功能页。在基础库版本低于 [2.4.0](../compatibility) 时，点击跳转到自己的功能页的 [functional-page-navigator](https://developers.weixin.qq.com/miniprogram/dev/component/functional-page-navigator.html) 将没有任何反应。
...
- 请检查引用插件的小程序和插件本身是不是同一个 AppID ，如果是，跳转到自己的功能页需要基础库 [2.4.0](../compatibility) 支持，否则使用 [functional-page-navigator](https://developers.weixin.qq.com/miniprogram/dev/component/functional-page-navigator.html) 不会有任何反应。
