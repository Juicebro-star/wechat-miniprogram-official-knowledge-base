...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/audits/best-practice.html"
source_route: "/miniprogram/dev/framework/audits/best-practice.html"
raw_html: "raw-html/audits/best-practice.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/audits/best-practice.html](https://developers.weixin.qq.com/miniprogram/dev/framework/audits/best-practice.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/audits/best-practice.html`
...
当使用的组件/API 的支持版本大于配置的线上最低基础库版本时，可能导致相应功能不可用。开发者可通过[调整最低基础库版本](../compatibility#设置最低基础库版本)或在[代码上兼容](../compatibility#兼容)的方式解决该问题。
