...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/visionkit/depth.html"
source_route: "/miniprogram/dev/framework/open-ability/visionkit/depth.html"
raw_html: "raw-html/open-ability/visionkit/depth.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/visionkit/depth.html](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/visionkit/depth.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/open-ability/visionkit/depth.html`
...
**AR模式**: (安卓微信>=8.0.38同时基础库>=2.33.0，iOS微信>=8.0.39同时基础库>=3.0.0) 使用摄像头和IMU进行深度估计，输出由near和far控制的非线性深度图，用于做虚实遮挡，目前支持部分机型，支持机型列表等同于[6Dof-水平面AR-V2平面AR接口支持列表](plane)。
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/b4f6b27d-252d-4f71-b830-57582f7c0464.png)
...
详情见[水平面AR中的V2+虚实遮挡](plane)

## 实时估计输出说明

### 1. 效果展示

![](https://res8.wxqcloud.qq.com.cn/wxdoc/15b64b91-a7dc-4509-b4e9-5da6936b861f.png)
...
![planev2_deepocc_gif](https://res8.wxqcloud.qq.com.cn/wxdoc/82635777-ecf9-46f2-a07e-d3d93244f055.gif)
