...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/visionkit/idcard.html"
source_route: "/miniprogram/dev/framework/open-ability/visionkit/idcard.html"
raw_html: "raw-html/open-ability/visionkit/idcard.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/visionkit/idcard.html](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/visionkit/idcard.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/open-ability/visionkit/idcard.html`
...
该能力，一般用于用户进行身份证识别或者身份证裁剪等功能的开发。
...
输入的身份证图片，尽量以正常的角度拍摄。不同角度带来的透视效果，会影响识别的准确度。
