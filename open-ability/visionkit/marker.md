---
title: "2D/3D物体AR能力 （2D/3D Marker AR）"
...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/visionkit/marker.html"
source_route: "/miniprogram/dev/framework/open-ability/visionkit/marker.html"
raw_html: "raw-html/open-ability/visionkit/marker.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/visionkit/marker.html](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/visionkit/marker.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/open-ability/visionkit/marker.html`
...
3. 在 v2 模式下，使用 平面识别 与 Marker检测 结合，允许 `同时识别多个 Marker`，同时可输出多个2d/3d marker 识别结果（需要基础库版本3.0.0)，目标在视野中消失后之前返回的pose位姿信息依然有效可用，具体可以参考 [平面AR能力扩展](plane-options) 以及内部的相关例子。
...
![demo-marker3d](../../assets/abc80c31fd9a4072.gif)
...
![demo-marker3d](../../assets/4545f16f8fc797c9.gif)

#### 3D Marker案例 默认识别 来源视频参考

![demo-marker3d](https://res.wx.qq.com/wxdoc/dist/assets/img/marker3d-example-lmcs.2289c6d1.gif)

#### 3D Marker案例 默认识别 图片

![demo-marker3d](https://res8.wxqcloud.qq.com.cn/wxdoc/be2de710-cdf3-4a35-b25a-87b6da037de8.png)
...
![marker2d](https://res.wx.qq.com/wxdoc/dist/assets/img/marker2d.89187544.gif)
...
![饮料、化妆瓶等容器类AR](https://res.wx.qq.com/wxdoc/dist/assets/img/marker3d-example-cola.7c4d903d.gif) ![公仔AR](https://res.wx.qq.com/wxdoc/dist/assets/img/marker3d.4bca8f40.gif)
