...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/NFC.html"
source_route: "/miniprogram/dev/framework/open-ability/NFC.html"
raw_html: "raw-html/open-ability/NFC.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/NFC.html](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/NFC.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/open-ability/NFC.html`

# NFC 标签打开小程序

> 安卓微信客户端 8.0.14 开始支持，iOS 现网版本均已覆盖。

基于小程序 [URL Scheme](url-scheme)，在现有短信、邮件、网页等场景外，微信还支持通过 NFC 卡片快捷拉起小程序页面的能力。可用于智能设备的快速配网、快捷控制等场景。
...
- URI Record
  ...
  - Type: `U`
  - Payload: 小程序 [URL Scheme](url-scheme)
...
小程序想要使用 NFC 标签打开小程序能力，首先需要接入设备，详见「[设备接入](../device/device-access)」文档。
...
申请能力通过后，通过 [获取NFC的小程序scheme](https://developers.weixin.qq.com/miniprogram/dev/server/API/qrcode-link/url-scheme/api_generatenfcscheme) 接口可以获取 NFC 场景下打开小程序任意页面的 URL Scheme 。
