...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/subscribe-message-overview.html"
source_route: "/miniprogram/dev/framework/open-ability/subscribe-message-overview.html"
raw_html: "raw-html/open-ability/subscribe-message-overview.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/subscribe-message-overview.html](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/subscribe-message-overview.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/open-ability/subscribe-message-overview.html`
...
详见[订阅消息接入 Beta开发指南](subscribe-message-2)文档。
...
详见[小程序订阅消息开发指南](subscribe-message)文档。
...
同时长期订阅消息支持[语音提醒](subscribe-message#订阅消息语音提醒)与[添加提醒](subscribe-message#订阅消息添加提醒)能力。
...
设备订阅消息是一种特殊类型的订阅消息，它属于长期订阅消息类型，且需要完成「[设备接入](../device/device-access)」才能使用。

设备订阅消息用于在设备触发某些需要人工介入的事件时（例如设备发生故障、设备耗材不足等），向用户发送消息通知。

详见[设备订阅消息](../device/device-message)文档。
