...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/user-encryptkey.html"
source_route: "/miniprogram/dev/framework/open-ability/user-encryptkey.html"
raw_html: "raw-html/open-ability/user-encryptkey.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/user-encryptkey.html](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/user-encryptkey.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/open-ability/user-encryptkey.html`

# 小程序加密网络通道

从基础库 [2.17.3](../compatibility) 开始支持
...
在开发者服务端，可以调用[*getUserEncryptKey*](https://developers.weixin.qq.com/miniprogram/dev/server/API/user-info/internet/api_getuserencryptkey)后台接口获取用户最近三次的key。在获取key的同时，接口会携带version信息，开发者可以比较version版本来选择使用对应的key对数据进行加解密。
...
可以参考此文档接入微信网关：[小程序一键接入微信网关](https://developers.weixin.qq.com/miniprogram/security/gateway/start/quickstart)
