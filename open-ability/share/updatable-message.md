...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/share/updatable-message.html"
source_route: "/miniprogram/dev/framework/open-ability/share/updatable-message.html"
raw_html: "raw-html/open-ability/share/updatable-message.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/share/updatable-message.html](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/share/updatable-message.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/open-ability/share/updatable-message.html`

# 动态消息

从基础库 [2.4.0](../../compatibility) 开始，支持转发动态消息。动态消息对比普通消息，有以下特点：
...
每条动态消息可以理解为一个活动，活动发起前需要通过 [创建 activity_id](https://developers.weixin.qq.com/miniprogram/dev/server/API/mp-message-management/updatable-message/api_createactivityid) 接口创建 `activity_id`。后续转发动态消息以及更新动态消息都需要传入这个 `activity_id`。
...
动态消息发出去之后，可以通过 [修改动态消息接口](https://developers.weixin.qq.com/miniprogram/dev/server/API/mp-message-management/updatable-message/api_setupdatablemsg) 修改消息内容。
