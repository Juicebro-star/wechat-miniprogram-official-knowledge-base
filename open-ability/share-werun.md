...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/share-werun.html"
source_route: "/miniprogram/dev/framework/open-ability/share-werun.html"
raw_html: "raw-html/open-ability/share-werun.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/share-werun.html](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/share-werun.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/open-ability/share-werun.html`

# 分享数据到微信运动

从基础库 [2.14.0](../compatibility) 开始支持

可将用户在小程序内的运动数据分享到微信运动。

## 申请开通

小程序管理后台，「开发」-「接口设置」中自助开通该组件权限。
只针对「体育-在线健身」类目的小程序开放。
...
![avatar](https://res8.wxqcloud.qq.com.cn/wxdoc/0bfc732e-3ca6-4fe0-a267-30e1dd315d5b.jpeg)
