...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/ad/interstitialAd-ad.html"
source_route: "/miniprogram/dev/framework/open-ability/ad/interstitialAd-ad.html"
raw_html: "raw-html/open-ability/ad/interstitialAd-ad.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/ad/interstitialAd-ad.html](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/ad/interstitialAd-ad.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/open-ability/ad/interstitialAd-ad.html`
...
插屏广告组件默认是隐藏的，因此可以提前创建，以提前初始化组件。开发者可以在小程序页面的 [onLoad](https://developers.weixin.qq.com/miniprogram/dev/reference/api/Page#onloadobject-query) 事件回调中创建广告实例，并在该页面的生命周期内重复调用该广告实例。
...
插屏广告组件默认是隐藏的，开发者需要调用 [InterstitialAd.show()](https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.html) 进行显示。如果广告拉取失败或触发频率限制，[InterstitialAd.show()](https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.html) 方法会返回一个rejected Promise，开发者可自行监听错误信息。[常见异常错误参考文档](https://developers.weixin.qq.com/miniprogram/dev/api/ad/InterstitialAd.html)
