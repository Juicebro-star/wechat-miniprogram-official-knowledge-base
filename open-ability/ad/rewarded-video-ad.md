...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/ad/rewarded-video-ad.html"
source_route: "/miniprogram/dev/framework/open-ability/ad/rewarded-video-ad.html"
raw_html: "raw-html/open-ability/ad/rewarded-video-ad.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/ad/rewarded-video-ad.html](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/ad/rewarded-video-ad.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/open-ability/ad/rewarded-video-ad.html`
...
激励视频广告组件默认是隐藏的，因此可以提前创建，以提前初始化组件。开发者可以在小程序页面的 [onLoad](https://developers.weixin.qq.com/miniprogram/dev/reference/api/Page#onloadobject-query) 事件回调中创建广告实例，并在该页面的生命周期内重复调用该广告实例。
...
激励视频广告组件默认是隐藏的，在用户主动触发广告后，开发者需要调用 [RewardedVideoAd.show()](https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.html) 进行显示。
...
如果拉取成功，通过 [RewardedVideoAd.onLoad()](https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.onLoad.html) 注册的回调函数会执行，[RewardedVideoAd.show()](https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.html) 返回的 Promise 也会是一个 resolved Promise。两者的回调函数中都没有参数传递。
...
[RewardedVideoAd.show()](https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.html) 返回的 Promise 也会是一个 rejected Promise。
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/305ce8ef-9ebb-4d0a-80e7-b96c9c11b5c0.png)
