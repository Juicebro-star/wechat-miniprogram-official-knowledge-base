...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/chatToolOpenMode.html"
source_route: "/miniprogram/dev/framework/open-ability/chatToolOpenMode.html"
raw_html: "raw-html/open-ability/chatToolOpenMode.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/chatToolOpenMode.html](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/chatToolOpenMode.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/open-ability/chatToolOpenMode.html`
...
开发者调用 `wx. enterChatToolMode` 后，可选择在 chatToolRooms 传入 opengid 以进入聊天模式，并获得聊天成员相关接口的调用权限；如果未传入 opengid，则将拉起群聊选择器；需要退出时可以调用 `wx.exitChatTool`。
...
返回参数（数据加密返回，解密请参考：[wx.getGroupEnterInfo](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/group/wx.getGroupEnterInfo.html)）：
...
1.  服务端通过[创建activity_id](https://developers.weixin.qq.com/miniprogram/dev/server/API/mp-message-management/updatable-message/api_createactivityid)接口创建 activity_id
