...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/device/device-tee.html"
source_route: "/miniprogram/dev/framework/device/device-tee.html"
raw_html: "raw-html/device/device-tee.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/device/device-tee.html](https://developers.weixin.qq.com/miniprogram/dev/framework/device/device-tee.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/device/device-tee.html`
...
hmac_sha256 为标准算法，一般 tee 里已有此类算法，如果没有，可参考[开源实现](https://github.com/ogay/hmac/blob/master/hmac_sha2.c)。
...
开发者完成 TEE 的 TA 开发后，应该进行测试用例开发，以验证 TA 的功能与逻辑。
前置条件：**ta_deauth 所管理的区域无任何数据**，再按顺序进行以下测试项。
