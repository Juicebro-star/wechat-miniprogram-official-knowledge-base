...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/device/voip/auth.html"
source_route: "/miniprogram/dev/framework/device/voip/auth.html"
raw_html: "raw-html/device/voip/auth.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/device/voip/auth.html](https://developers.weixin.qq.com/miniprogram/dev/framework/device/voip/auth.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/device/voip/auth.html`
...
用户授权前，需要从开发者的后台通过[获取设备票据](https://developers.weixin.qq.com/miniprogram/dev/server/API/hardware-device/api_getsnticket) 接口拿到设备票据 snTicket。
...
- 授权框中「设备名字」= 「deviceName」 + 「modelId 对应设备型号」。如「deviceName」为「iot」，modelId 对应设备型号是「校园电话」，最终名字为「iot 校园电话」

![](https://res8.wxqcloud.qq.com.cn/wxdoc/c9d885b0-4d14-4ee2-b579-390924154c31.jpg)
...
如果需要批量授权，可以创建[设备组](../device-group)。在用户授权和设备进行音视频通话时，可以批量授权给一个设备组，而无需对每台设备重复授权。
...
由插件提供 [getIotBindContactList](../voip-plugin/api/getIotBindContactList) 接口，**一般在设备端使用**，可用于在设备端发起通话前（如联系人页面）检查授权状态。
