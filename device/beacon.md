...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/device/beacon.html"
source_route: "/miniprogram/dev/framework/device/beacon.html"
raw_html: "raw-html/device/beacon.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/device/beacon.html](https://developers.weixin.qq.com/miniprogram/dev/framework/device/beacon.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/device/beacon.html`

# 蓝牙信标 (Beacon)

> 基础库 1.2.0 开始支持。

蓝牙信标 (Beacon) 是建立在[蓝牙低功耗 (BLE)](ble) 协议基础上的一种广播协议。
