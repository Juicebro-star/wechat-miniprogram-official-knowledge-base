...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/device/voip-plugin/api/callDevice.html"
source_route: "/miniprogram/dev/framework/device/voip-plugin/api/callDevice.html"
raw_html: "raw-html/device/voip-plugin/api/callDevice.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/device/voip-plugin/api/callDevice.html](https://developers.weixin.qq.com/miniprogram/dev/framework/device/voip-plugin/api/callDevice.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/device/voip-plugin/api/callDevice.html`
...
从手机客户端的小程序呼叫 Linux 设备、RTOS 设备。调用此接口后，会创建 VoIP 房间。开发者应自行向设备端推送通话提醒。详情参考[《手机微信呼叫设备(Linux 直连)》](../../voip/call-device)。
