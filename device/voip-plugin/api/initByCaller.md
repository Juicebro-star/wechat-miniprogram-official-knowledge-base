...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/device/voip-plugin/api/initByCaller.html"
source_route: "/miniprogram/dev/framework/device/voip-plugin/api/initByCaller.html"
raw_html: "raw-html/device/voip-plugin/api/initByCaller.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/device/voip-plugin/api/initByCaller.html](https://developers.weixin.qq.com/miniprogram/dev/framework/device/voip-plugin/api/initByCaller.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/device/voip-plugin/api/initByCaller.html`
...
| errCode | number | 错误码，取值参考[错误码文档](errCode) |  |
| errMsg | string | 错误信息 |  |
| errObj | [VoipError](errCode) | 错误对象 | 2.4.0 |
...
| --- | --- | --- | --- | --- |
| 1 | 硬件设备呼叫手机微信 | 设备 SN | 微信用户 openId | 使用[设备认证 SDK](../../device-register-sdk)注册的设备传入 deviceToken. 使用 [WMPF 注册的设备](../../device-register-wmpf)不能有这个字段（插件 2.3.0 支持） |
| 2 | 手机微信呼叫硬件设备 | 微信用户 openId | 设备 SN | 从设备获取的 [pushToken](https://developers.weixin.qq.com/doc/oplatform/Miniprogram_Frame/push) |

- 发起通话前，需要在提前让 openId 对应的用户在微信客户端的小程序内进行授权，具体流程请参见[授权文档](../../voip/auth)；
