...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/changelog.html"
source_route: "/miniprogram/dev/framework/runtime/skyline/changelog.html"
raw_html: "raw-html/runtime/skyline/changelog.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/changelog.html](https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/changelog.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/runtime/skyline/changelog.html`
...
1. 新增 selection 组件支持跨多个 text 段落选择
2. 新增 text 组件新增 getBoxesForRange 接口
3. 新增 list-view 组件新增 itemmount / itemunmount 事件
4. 新增 image 组件 load 事件新增时间戳
5. 更新 文本选区颜色修正为微信绿
6. 修复 backdrop-filter 属性边缘显示异常的问题
7. 修复 自定义路由取消手势返回导致页面卡死的问题
8. 修复 嵌套 text 组件的 getBoundingClientRect 接口返回坐标错误的问题
9. 修复 scroll-view 插入节点的同时设置 scrollTop 偶现滚动跳动的问题
10. 修复 worklet 内存泄露问题
11. 修复 鸿蒙端启动偶现白屏问题

## 1.4.21 (2026-08-26)

1. 新增 selection 组件支持 selection-color 属性
2. 修复 swiper 设置 previous-margin 为 vw 闪退问题
3. 修复 svg 图片解码循环问题
4. 修复 嵌套 text 节点无法响应事件的问题
5. 修复 background-size / mask-size 不支持 css variable 的问题
6. 修复 打开半屏小程序后再启动 skyline 页面引起的布局错误问题

## 1.4.20 (2026-06-10)

1. 新增 text 组件支持 select-on-gesture 属性，用于禁用手势触发文本选区
2. 新增 measureText 接口，用于测量文本尺寸
3. 新增 selection 组件支持 selectRange 接口，支持设置文本选区
4. 新增 picker-view 组件支持自定义放大镜效果参数
5. 修复 selection 组件子节点布局异常问题
6. 修复 自定义路由下 scroll-view 无法横向拖动的问题
7. 修复 span 内联元素无法正确获取 getBoundingClientRect 的问题
8. 修复 masonry 网格布局在子节点减少时出现的布局问题
9. 修复 scroll-view 下拉刷新多次设置 triggered 为 false 导致死循环的问题
10. 修复 scroll-view 滚动锚定在特定条件下导致内容跳动的问题
11. 修复 工具端 scroll-view 出现双滚动条的问题

## 1.4.19 (2026-05-06)

1. 修复 word-break: all 文本截断问题
2. 修复 video 周围黑线问题
3. 修复 wxss 动画贝塞尔曲线表现错误
4. 修复 conic-gradient 渐变问题
5. 修复 scroll-view 下拉刷新影响无障碍
6. 修复 scroll-view 自动撑高问题
7. 修复 image 在退页后仍回调 onerror 事件的问题
8. 修复 wxss animation 无效输入下的闪退问题
9. 修复 input composition 状态在 setData 后丢失的问题

## 1.4.18 (2026-04-16)

1. 更新 鸿蒙 skyline 内存占用优化
2. 更新 开发者工具 electron 版本支持 skyline
3. 更新 新增样式表动态更新接口以支持开发者工具热更新
4. 更新 scroll-view anchoring 功能增强
5. 更新 setData callback 使用 skyline 渲染回调
6. 修复 scroll-view 并行布局问题
...
1. 新增 tag 选择器增加 legacy 选项以兼容 WebView（不受组件隔离限制） [详情](wxss#开启tag选择器全局匹配)
...
1. 新增 开发者工具支持真机调试
2. 新增 CSS 支持 flex order [详情](wxss)
3. 新增 CSS 支持 will-change: contents，用于声明绘制边界 [详情](wxss)
4. 新增 支持全局跨页面组件 [详情](appbar)
5. 新增 支持 apng 动图
6. 新增 scroll-view 组件支持 builder 模式，用于按需构建在屏节点 [详情](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html##%E5%88%97%E8%A1%A8%E6%9E%84%E9%80%A0%E5%99%A8%E4%BD%BF%E7%94%A8%E6%96%B9%E6%B3%95)
7. 新增 picker-view 组件支持 indicator-style 属性
8. 新增 input 键盘动画提供 worklet 回调，用于实现键盘跟随动画 [详情](https://developers.weixin.qq.com/miniprogram/dev/api/ai/inference/Tensors.html#:~:text=worklet:onkeyboardheightchange)
...
3. 新增 [draggable-sheet](https://developers.weixin.qq.com/miniprogram/dev/api/skyline/DraggableSheetContext.scrollTo.html) 滚动容器组件，用于快速实现半屏交互
4. 新增 [swiper](https://developers.weixin.qq.com/miniprogram/dev/component/swiper.html#:~:text=layout%252Dtype) 组件支持一批新的交互动画类型，用于实现常见的原生交互效果
5. 新增 scroll-view 组件支持 [type="nested"](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html#:~:text=type)，用于处理 scroll-view 嵌套的场景
6. 新增 input 组件支持 [cursor-color](https://developers.weixin.qq.com/miniprogram/dev/api/ai/inference/Tensors.html#:~:text=cursor%252Dcolor) 属性，可自定义光标颜色
7. 新增 input 组件支持 [compositionstart](https://developers.weixin.qq.com/miniprogram/dev/api/ai/inference/Tensors.html#:~:text=bind:keyboardcompositionstart) / compositionupdate / compositionend 事件，用于感知输入草稿状态
8. 新增 input 组件支持 [selectionchange](https://developers.weixin.qq.com/miniprogram/dev/api/ai/inference/Tensors.html#:~:text=bind:selectionchange) 事件，用于感知光标位置变化
...
12. 新增 自定义路由增加 [fullscreenDrag](custom-route#:~:text=fullscreenDrag) 配置项，使得全屏范围内都可以右滑返回
...
6. 优化 Skyline 首次渲染性能
7. 优化 [snapshot](https://developers.weixin.qq.com/miniprogram/dev/api/media/live/LivePlayerContext.snapshot.html) 组件支持导出长图
...
1. 新增 CSS 支持 animation 属性 [详情](wxss)
2. 新增 [scroll-view](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html#:~:text=refresher%252Dtwo%252Dlevel%252Denabled) 组件支持下拉二楼交互
3. 新增 [snapshot](https://developers.weixin.qq.com/miniprogram/dev/api/media/live/LivePlayerContext.snapshot.html) 截图组件，用于将组件内的 WXML 内容导出图片
...
5. 新增 [text](https://developers.weixin.qq.com/miniprogram/dev/api/media/map/wx.createMapContext.html#:~:text=overflow) 组件支持 overflow 属性，用于对齐文本省略特性
6. 新增 scroll-view 组件下的直接子节点 height 支持 % 单位
7. 新增 开发者工具上支持 backgroundColorContent 配置项 [详情](custom-route#设置页面透明)
...
1. 新增 CSS 支持 calc 函数 [详情](wxss)
2. 新增 CSS 支持伪元素 before 和 after [详情](wxss)
3. 新增 CSS 支持 var 函数 [详情](wxss)
4. 新增 CSS 支持 mask-image 属性 [详情](wxss)
5. 新增 支持 [picker-view](https://developers.weixin.qq.com/miniprogram/dev/component/picker-view.html) 组件
6. 新增 [scroll-view](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html#:~:text=clip) 组件支持 clip 属性，可显示溢出内容
7. 新增 [scroll-view](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html#:~:text=padding) / [grid-view](https://developers.weixin.qq.com/miniprogram/dev/component/grid-view.html) / [list-view](https://developers.weixin.qq.com/miniprogram/dev/component/list-view.html) / [sticky-header](https://developers.weixin.qq.com/miniprogram/dev/component/sticky-header.html) / [sticky-section](https://developers.weixin.qq.com/miniprogram/dev/component/list-view.html) 组件支持 padding 属性，设置组件内部的内边距
8. 新增 [scroll-view](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html) 组件直接子节点支持 CSS margin
9. 新增 [scroll-view](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html#:~:text=min%2Ddrag%2Ddistance) 组件支持 min-drag-distance 属性，设置起始滚动阈值
10. 新增 text / span 组件支持内联 view 等普通节点
11. 新增 支持新版本组件框架 glass-easel [详情](../../custom-component/glass-easel/migration)
12. 优化 完善 SVG 支持度
13. 优化 自定义路由接口设计，以及启动页无法绑定自定义路由 [详情](custom-route)
...
25. 修复 [scroll-view](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html) 组件 bounces 和 refresher 冲突
26. 修复 [scroll-view](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html) 组件触底加载更多回弹动画曲线异常
27. 修复 [scroll-view](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html) 组件快速滚动时无法加载更多节点
...
33. 修复 [video](https://developers.weixin.qq.com/miniprogram/dev/api/media/video/VideoContext.html) 组件在 [scroll-view](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html) 下滚动出去再回来时消失
...
1. 新增 CSS 支持 block 布局 [详情](wxss)
2. 新增 <share-element> on-frame 支持返回自定义 rect
3. 新增 开发者工具支持 CSS env safe-area-inset-*
4. 优化 使 [scroll-view](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html) 组件在内容未溢出时也能够滚动
5. 优化 对字体模块预热，减少字体测量的耗时
6. 优化 image 本地缓存读取性能
7. 优化 对 JS 线程部分任务提高优先级
8. 修复 文本字号不受系统字体配置影响
9. 修复 [scroll-view](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html) 组件下使用 image 组件的 fade-in 属性时布局异常的问题
...
19. 修复 [scroll-view](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html) 组件 custom 模式下无法下拉刷新
20. 修复 [scroll-view](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html) 组件 bindscrolltolower 和 bindscrolltoupper 多次触发问题
...
2. 新增 支持 share-element 更多自定义特性 [详情](share-element)
3. 新增 完善 swiper 特性支持（bindtransition、bindanimationfinish、display-multiple-items） [详情](https://developers.weixin.qq.com/miniprogram/dev/component/swiper.html)
4. 新增 swiper 组件支持手势协商 [详情](gesture)
5. 新增 swiper 支持 scroll-with-animation 及 cache-extent 属性 [详情](https://developers.weixin.qq.com/miniprogram/dev/component/swiper.html)
6. 新增 支持解析 CSS text-shadow
7. 新增 与 applyAnimatedStyle 配套使用的 clearAnimatedStyle 接口
8. 新增 doubletap 手势返回坐标信息 [详情](gesture)
...
3. 新增 支持 rem 单位
4. 新增 scroll-view 支持 custom type [详情](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html)
5. 新增 scroll-view 下拉刷新增加 willRefresh 事件和 bounce 优化 [详情](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html)
6. 新增 scroll-view 支持 scrollend 事件和 scrolling reason [详情](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html)
7. 新增 scroll-view 增加 scroll-into-view-alignment / scroll-into-view-within-extent 属性 [详情](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html)
8. 新增 scroll-view 增加 cache-extent 属性 [详情](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html)
9. 新增 小程序页面背景颜色支持
10. 优化 图片缓存内存占用
11. 优化 skyline 释放流程
...
1. 新增 darkmode 支持 [详情](../../ability/darkmode)
2. 新增 span 组件，用于图片与文本内联布局 [详情](https://developers.weixin.qq.com/miniprogram/dev/component/map.html)
3. 新增 scroll-view reverse 属性，支持反向滚动 [详情](https://developers.weixin.qq.com/miniprogram/dev/api/wxml/NodesRef.scrollOffset.html)
4. 新增 CSS 支持 first-child / last-child 伪类 [skyline wxss 样式支持与差异](wxss)
