...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/custom-route.html"
source_route: "/miniprogram/dev/framework/runtime/skyline/custom-route.html"
raw_html: "raw-html/runtime/skyline/custom-route.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/custom-route.html](https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/custom-route.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/runtime/skyline/custom-route.html`
...
下方为半屏页面效果，[点击可查看更多 Skyline 示例](experience)。

![](../../assets/7f1e4113280e6718.gif)

扫码打开小程序示例，交互动画 - 基础组件 - 自定义路由 即可体验。

![](../../assets/148678eb3337e38a.bin)

## 使用方法

建议先阅读完 [worklet 动画](worklet) 和 [手势系统](gesture) 两个章节，它们是自定义路由的基础内容。

### 接口定义

自定义路由相关的接口

- 页面跳转 [wx.navigateTo](https://developers.weixin.qq.com/miniprogram/dev/api/navigate/wx.navigateToMiniProgram.html)
...
在页面推入后，除了调用 `wx.navigateBack` 接口返回上一级外，还可以通过手势来处理，例如 `iOS` 上常见的右滑返回。自定义路由模式下，开发者可根据不同的页面转场效果，来选取所需的退出方式，如半屏效果可采用下滑返回。关于手势监听的内容，可参考 [手势系统](gesture) 一章，路由手势仅是在其基础上，补充了几个路由相关的接口。
