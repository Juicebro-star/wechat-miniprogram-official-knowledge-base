...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/wxss.html"
source_route: "/miniprogram/dev/framework/runtime/skyline/wxss.html"
raw_html: "raw-html/runtime/skyline/wxss.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/wxss.html](https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/wxss.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/runtime/skyline/wxss.html`
...
| 一般兄弟选择器 | a ~ b {} | ✓ | 8.0.49 |
| 紧邻兄弟选择器 | a + b {} | ✓ | 8.0.49 |
| 伪类选择器 | :first-child {} | ✓ | 支持 :first-child / :last-child；微信 8.0.49 起（对应 Skyline 1.3.0）支持 :not / :only-child / :empty；微信 8.0.50 起（对应 Skyline 1.3.3）支持 :nth-child |
...
Skyline 下 @keyframe 规则遵循样式隔离机制，而 WebView 下不受样式隔离约束，可通过 `keyframeStyleIsolation: legacy` 配置对齐 WebView 表现，若指定 `keyframeStyleIsolation: isolated` 则遵循样式隔离机制。
...
![](../../assets/fe8486145a0a9f65.svg)文档变更日志（1条）
