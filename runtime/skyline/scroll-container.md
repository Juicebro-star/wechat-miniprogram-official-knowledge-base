...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/scroll-container.html"
source_route: "/miniprogram/dev/framework/runtime/skyline/scroll-container.html"
raw_html: "raw-html/runtime/skyline/scroll-container.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/scroll-container.html](https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/scroll-container.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/runtime/skyline/scroll-container.html`
...
![](../../assets/09289aeb39f6049f.png)

上图是 `builder` 模式在开发者工具中 `wxml` 的渲染结果，仅在屏列表项会被真正创建节点，离屏后列表项会被回收，滚动时始终几个子节点。

#### 示例代码片段

[在开发者工具中预览效果](https://developers.weixin.qq.com/s/z25kA6mv7gPx "在开发者工具中预览效果")
...
[在开发者工具中预览效果](https://developers.weixin.qq.com/s/1IaEOym777Mx "在开发者工具中预览效果")
