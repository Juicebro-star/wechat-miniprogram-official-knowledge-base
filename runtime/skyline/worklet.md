...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/worklet.html"
source_route: "/miniprogram/dev/framework/runtime/skyline/worklet.html"
raw_html: "raw-html/runtime/skyline/worklet.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/worklet.html](https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/worklet.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/runtime/skyline/worklet.html`
...
`worklet` 函数和共享变量就是用来解决交互动画问题的。相关接口 `applyAnimatedStyle` 可通过页面/组件实例访问，[接口文档参考](#applyAnimatedStyle-参数定义)。
...
当然，光看这个例子，跟用 `setData` 看好像没有什么区别。但当 `worklet` 动画和[手势](gesture)结合时，就产生了质变。
...
[查看更多手势处理的示例代码](gesture#%E4%BD%BF%E7%94%A8%E6%96%B9%E6%B3%95)
...
### applyAnimatedStyle 接口参数定义

| 定义段 | 类型 | 是否必填 | 描述 | 最低版本 |
| --- | --- | --- | --- | --- |
| selector | String | 是 | 节点选择器 | [2.29.0](../../compatibility) |
| updater | Function | 是 | worklet 样式更新函数 | [2.29.0](../../compatibility) |
| userConfig | Object | 否 | 配置项 | [2.30.1](../../compatibility) |
| callback | Function | 否 | 完成样式绑定的回调 | [2.30.1](../../compatibility) |
...
`selector` 语法同 [SelectorQuery.select](wxml/SelectorQuery.select)。
...
### clearAnimatedStyle 接口参数定义

| 定义段 | 类型 | 是否必填 | 描述 | 最低版本 |
| --- | --- | --- | --- | --- |
| selector | String | 是 | 节点选择器 | [2.30.1](../../compatibility) |
| styleIds | `Array<Number>` | 是 | 需要清除的 styleId 集合 | [2.30.1](../../compatibility) |
| callback | Function | 否 | 清除样式绑定的回调 | [2.30.1](../../compatibility) |
