...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/migration/best-practice.html"
source_route: "/miniprogram/dev/framework/runtime/skyline/migration/best-practice.html"
raw_html: "raw-html/runtime/skyline/migration/best-practice.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/migration/best-practice.html](https://developers.weixin.qq.com/miniprogram/dev/framework/runtime/skyline/migration/best-practice.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/runtime/skyline/migration/best-practice.html`

# 最佳实践

## 按需注入

Skyline 依赖 [按需注入](../../../ability/lazyload) 特性。按需注入特性开启后，小程序的部分表现会发生变化，有可能带来兼容问题（具体见按需注入特性文档）；因此建议在开始适配 Skyline 前，先开启按需注入并妥善测试，以提前排除该特性带来的影响。
...
因此，为了让 WebView 的兼容表现尽量对齐 Skyline，同时减少重复设置的代码，建议全局开启下述配置项：
...
为了使小程序的体验能够更接近原生 APP，Skyline 新增了若干个特性，包括 [worklet 动画机制](../worklet)、[手势系统](../gesture)、[自定义路由](../custom-route)、[共享元素动画](../share-element)等，这些特性使得 Skyline 能够做出一些 WebView 下无法实现或实现效果不够流畅的交互动效。
