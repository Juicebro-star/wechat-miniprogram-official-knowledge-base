...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/ability/background-fetch.html"
source_route: "/miniprogram/dev/framework/ability/background-fetch.html"
raw_html: "raw-html/ability/background-fetch.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/ability/background-fetch.html](https://developers.weixin.qq.com/miniprogram/dev/framework/ability/background-fetch.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/ability/background-fetch.html`
...
![数据周期性更新配置页面](../assets/535d4d8613bfff00.png) ![数据周期性更新数据来源配置](../assets/f31854c610f431a7.png)
...
因此为了方便调试周期性数据，工具提供了下面的调试能力给到开发者，具体可查看[周期性数据调试](https://developers.weixin.qq.com/minigame/dev/guide/base-ability/background-fetch)。
