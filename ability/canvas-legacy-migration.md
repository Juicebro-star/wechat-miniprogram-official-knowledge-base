...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/ability/canvas-legacy-migration.html"
source_route: "/miniprogram/dev/framework/ability/canvas-legacy-migration.html"
raw_html: "raw-html/ability/canvas-legacy-migration.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/ability/canvas-legacy-migration.html](https://developers.weixin.qq.com/miniprogram/dev/framework/ability/canvas-legacy-migration.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/ability/canvas-legacy-migration.html`

# 旧版 Canvas 迁移指南

小程序的旧版 canvas 接口已经不再维护，本指南将指引如何迁移至新版 [Canvas 2D 接口](canvas)。
...
新版 Canvas 2D 接口需要先通过 [SelectorQuery](https://developers.weixin.qq.com/miniprogram/dev/api/media/map/wx.createMapContext.html) **异步**获取 [Canvas 对象](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.html)，再通过 [Canvas.getContext](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/OffscreenCanvas.getContext.html) 获取渲染上下文 [RenderingContext](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/Path2D.html)。
...
新版 Canvas 2D 接口需要先通过 [Canvas.createImage](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/OffscreenCanvas.createImage.html) 创建图片对象，`onload` 图片加载完成回调触发后，再将图片对象传入 `context.drawImage` 进行绘制。
...
新版 Canvas 2D 接口需要直接传入 [Canvas 实例](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.html)
