...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/view/frameset.html"
source_route: "/miniprogram/dev/framework/view/frameset.html"
raw_html: "raw-html/view/frameset.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/view/frameset.html](https://developers.weixin.qq.com/miniprogram/dev/framework/view/frameset.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/view/frameset.html`

# 分栏模式

在 PC 等能够以较大屏幕显示小程序的环境下，小程序支持以分栏模式展示。分栏模式可以将微信窗口分为左右两半，各展示一个页面。

![frameset-screenshot](../assets/aa643528c97c3f4a.png)
...
因此，应当将这样的路由接口改成 [Router](https://developers.weixin.qq.com/miniprogram/dev/reference/api/Router) 接口调用，如 `this.pageRouter.navigateTo` 。

### 页面大小不是固定值

启用分栏模式的同时，页面大小也是可能动态变化的了。请使用 [响应显示区域变化](resizable) 的方法来处理页面大小变化时的响应方式。
