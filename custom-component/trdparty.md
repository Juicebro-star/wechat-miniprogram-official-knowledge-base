...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/custom-component/trdparty.html"
source_route: "/miniprogram/dev/framework/custom-component/trdparty.html"
raw_html: "raw-html/custom-component/trdparty.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/custom-component/trdparty.html](https://developers.weixin.qq.com/miniprogram/dev/framework/custom-component/trdparty.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/custom-component/trdparty.html`

# 开发第三方自定义组件

小程序从基础库版本 [2.2.1](../compatibility) 开始支持使用 npm 安装第三方包，因此也支持开发和使用第三方自定义组件包。关于 npm 功能的详情可先阅读[相关文档](https://developers.weixin.qq.com/minigame/dev/devtools/npm)。

## 准备

开发一个开源的自定义组件包给他人使用，首先需要明确他人是要如何使用这个包的，如果只是拷贝小程序目录下直接使用的话，可以跳过此文档。此文档中后续内容是以 npm 管理自定义组件包的前提下进行说明的。

在开发之前，要求开发者具有基础的 node.js 和 npm 相关的知识，同时需要准备好支持 npm 功能的开发者工具，[点此下载](https://developers.weixin.qq.com/miniprogram/dev/devtools/download)。
...
命令执行完毕后会发现项目根目录下生成了许多文件，这是根据官方的[项目模板](https://github.com/wechat-miniprogram/miniprogram-custom-component)生成的完整项目，之后可直接在此之上进行开发修改。
...
针对自定义组件的单元测试，可参阅文档[单元测试](unit-test)。
