...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/performance/tips/start_optimizeB.html"
source_route: "/miniprogram/dev/framework/performance/tips/start_optimizeB.html"
raw_html: "raw-html/performance/tips/start_optimizeB.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/performance/tips/start_optimizeB.html](https://developers.weixin.qq.com/miniprogram/dev/framework/performance/tips/start_optimizeB.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/performance/tips/start_optimizeB.html`

# 代码注入优化

小程序代码注入的优化可以从**优化代码量**和**优化执行耗时**两个角度着手。

## 1. 使用[按需注入](../../ability/lazyload#按需注入)
...
## 2. 使用[用时注入](../../ability/lazyload#用时注入)
...
建议优先使用拆分后的 getSystemSetting/getAppAuthorizeSetting/getDeviceInfo/getWindowInfo/getAppBaseInfo 按需获取信息，或使用使用异步版本 [getSystemInfoAsync](https://developers.weixin.qq.com/miniprogram/dev/api/base/system/wx.getSystemInfo.html)。
