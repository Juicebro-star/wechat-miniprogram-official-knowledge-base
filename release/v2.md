...
official_url: "https://developers.weixin.qq.com/miniprogram/dev/framework/release/v2.html"
source_route: "/miniprogram/dev/framework/release/v2.html"
raw_html: "raw-html/release/v2.html"
---

> 来源：微信开放文档（官方页面）
> 原始链接：[https://developers.weixin.qq.com/miniprogram/dev/framework/release/v2.html](https://developers.weixin.qq.com/miniprogram/dev/framework/release/v2.html)
> 抓取日期：2026-09-05
> 原始 HTML：`raw-html/release/v2.html`
...
3. `A` 新增 自定义组件 全局样式类功能
4. `A` 新增 自定义组件 `lifetimes` 定义段，用于收归现有生命周期 [详情](https://developers.weixin.qq.com/miniprogram/dev/reference/api/Component)
5. `A` 新增 自定义组件 `pageLifetimes` 定义段，用于获取当前所在页面的生命周期 [详情](https://developers.weixin.qq.com/miniprogram/dev/reference/api/Component)
6. `A` 新增 自定义组件 扩展功能 [详情](../custom-component/extend)
7. `A` 新增 自定义组件 内置 behavior `wx://component-export`，用于支持 `export` 定义段 [详情](../component-framework/behaviors#wxcomponent-export)
